var BaseService, Promise, REGEX_LAST, Utils, debug, _;
...
BaseService = (function() {
  ...
  BaseService.prototype._wrapResponse = function(resolve, reject, originalRequest, error, response, body) {
    var endpoint, errorResp, responseJson, _ref;
    ...
    if (error) {
      ...
      return reject(_.extend(responseJson, errorResp));
    } else {
      if ((200 <= (_ref = response.statusCode) && _ref < 300)) {
        ...
        return reject(_.extend(responseJson, {
          statusCode: 404,
          message: "Endpoint '" + endpoint + "' not found.",
          originalRequest: originalRequest
        }));
      } else {
        return reject(_.extend(responseJson, body, {
          originalRequest: originalRequest
        }));
      }
    }

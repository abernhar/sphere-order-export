var Connection, Promise, Sftp, debug, uniqueId, _;
...
Sftp = (function() {
  ...
  Sftp.prototype.listFiles = function(sftp, dirName) {
    return new Promise(function(resolve, reject) {
      return sftp.opendir(dirName, function(err, handle) {
        if (err) {
          return reject(err);
        } else {
    ...
    return new Promise((function(_this) {
      return function(resolve, reject) {
        return _this.listFiles(sftp, remoteFolder).then(function(files) {
          ...
          return Promise.all(_.map(filteredFiles, function(f) {
            ...
            return Promise.all(_.map(filesOnly, function(f) {
